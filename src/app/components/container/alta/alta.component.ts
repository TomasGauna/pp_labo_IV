...
export class AltaComponent {
  ...
  enviar()
  {
    let obj = {codigo: this.form.getRawValue().codigo, color: this.form.getRawValue().color, empresa: this.form.getRawValue().empresa, capacidad: this.form.getRawValue().capacidad};
